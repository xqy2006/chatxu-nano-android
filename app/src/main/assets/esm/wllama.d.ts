...
export declare class Wllama {
    cacheManager: {
        ...
        write(name: string, stream: ReadableStream<any>, metadata: import("./cache-manager").CacheEntryMetadata): Promise<void>;
        open(name: string): Promise<ReadableStream<any> | null>;
        getSize(name: string): Promise<number>;
        getMetadata(name: string): Promise<import("./cache-manager").CacheEntryMetadata | null>;
        ...
        _writeMetadata(name: string, metadata: import("./cache-manager").CacheEntryMetadata): Promise<void>;
    };
    private proxy;
    private config;
    private pathConfig;
